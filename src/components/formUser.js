                                    ...
                                    <Form onSubmit={(e) => this.submitForm(e)}>
                                        <Form.Row>
                                            <Form.Group as={Col} controlId="FormGridName">
                                                ...
                                                <Form.Control placeholder="Inserte su nombre..." onChange={event => this.onChanged(event,'name')} value={this.state.nameText}></Form.Control>
                                            </Form.Group>
                                            <Form.Group as={Col} controlId="FormGridLastName">
                                                <Form.Label>Apellidos</Form.Label>
                                                <Form.Control placeholder="Inserte sus apellidos..." onChange={event => this.onChanged(event,'lastName')} value={this.state.lastNameText}></Form.Control>
                                            </Form.Group>
                                        </Form.Row>
                                        <Form.Row>
                                            <Form.Group as={Col} controlId="FormGriCel">
                                                ...
                                                <OverlayTrigger overlay={<Tooltip id="tooltip-disabled">Este sera su nuevo usuario dentro de la app</Tooltip>}>
                                                    <Form.Control onChange={event => this.onChanged(event,'numCel')} value={this.state.numText} placeholder="Inserte numero de celular"></Form.Control>
                                                </OverlayTrigger>

                                            </Form.Group>
                                            <Form.Group as={Col} controlId="FormGridTc">
                                                <Form.Label>Tarjeta de credito </Form.Label>
                                                <Form.Control type="password" placeholder="Inserte numero de tarjeta de credito" onChange={event => this.onChanged(event,'credit')} value={this.state.creditText}></Form.Control>
                                            </Form.Group>
                                        </Form.Row>
                                        ...
                                        <Form.Group controlId="formGridAddress2">
                                            ...
                                            <OverlayTrigger overlay={<Tooltip id="tooltip-disabled">Te recomendamos que crees una contraseña de al menos 8 caracteres, símbolos y números</Tooltip>}>
                                                <Form.Control type="password" placeholder="Ingrese su contraseña" onChange={event => this.onChanged(event,'pass')} value={this.state.passText}/>
                                            </OverlayTrigger>
                                        </Form.Group>
